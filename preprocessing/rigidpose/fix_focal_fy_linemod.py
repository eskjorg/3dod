...
# root_path = '/home/lucas/datasets/pose-data/sixd/occluded-linemod-augmented3_format06'
root_path = '/home/lucas/datasets/pose-data/sixd/occluded-linemod-augmented3_format06_backup'
...
for seq_path in seq_paths:
    ...
    for frame_idx, frame_info in info_yaml.items():
        frame_info['cam_K'][4] = 573.57043000
